...
import numbers
from .network_swinir import window_reverse,window_partition,WindowAttention,DropPath,to_2tuple
...
class SMSBlock(nn.Module):
    def __init__(self,
        ...
        self.smsblock = nn.Sequential(*[SSMTDA(dim=dim,input_resolution=[64,64], num_heads=num_head, window_size=window_size,
                                 ...
                                 qkv_bias=qkv_bias, qk_scale=qk_scale,LayerNorm_type=layerNorm_type,bias=bias )
